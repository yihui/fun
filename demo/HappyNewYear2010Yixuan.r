## Letters "Happy New Year" rotating on the screen
## original code by Yixuan Qiu <yixuan.qiu@cos.name>
## URL: http://yixuan.cos.name/cn/wp-content/uploads/2009/12/2010.R
...
replicate(100, {
    for (j in 1:238) {
        ...
        xscale = -sin(th) * 1.2
        plot(1, xlim = c(-2, 8), ylim = c(-2.5, 3.5), type = "n", asp = 1)
