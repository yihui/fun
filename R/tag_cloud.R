...
#' }
tag_cloud = function(tagData, htmlOutput = "tagCloud.html", SWFPath = 'tagcloud.swf',
                     JSPath = 'swfobject.js', divId = "tagCloudId", 
                     width = 600, height = 400, transparent = FALSE, 
                     tcolor = "333333", tcolor2 = "009900", hicolor = "ff0000", 
                     distr = "true", tspeed = 100, version = 9,
